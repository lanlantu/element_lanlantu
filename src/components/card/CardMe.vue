<template>
  <el-card>
    <h1 class="me-author-name">兰兰兔</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;四川&乐山</span>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'WX', message: '13388263076'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://space.bilibili.com/388067905">https://space.bilibili.com/388067905</a>'
        }
      }
    },
    methods: {
